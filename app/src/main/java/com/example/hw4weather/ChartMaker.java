...
public class ChartMaker {
    ...
    public TreeMap<String, Double> getWeatherEntries() {
    ...
    public void makeChart(TreeMap<String, Double> temperatureData,
        ...
        setupChart(binding.chartView);
        setupXAxis(binding.chartView);
        setupYAxis(binding.chartView);
        setData(binding.chartView, temperatureData);
